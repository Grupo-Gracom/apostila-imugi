...
//UNIDADE 8
Route::post('/apostila4/unidade8/grammar/respostas', 'RespostaController@store');
Route::get('/apostila4/unidade8/grammar/respostasCheck/{atividade_id}', 'RespostaController@check');
Route::post('/apostila4/unidade8/listening/respostas', 'RespostaController@store');
Route::get('/apostila4/unidade8/listening/respostasCheck/{atividade_id}', 'RespostaController@check');
Route::post('/apostila4/unidade8/understanding/respostas', 'RespostaController@store');
Route::get('/apostila4/unidade8/understanding/respostasCheck/{atividade_id}', 'RespostaController@check');
