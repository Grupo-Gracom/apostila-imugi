...
<!-- WRAPPER ALL -->
	...
	<main>
		...
		<div class="dashboard">
			<div id="unidade" class="box" data-unidade="unidade18" data-etapa="conversation">
				...
				<p style="margin-top: 16px"><b>Akira :</b> Good afternoon, everyone. Last class, angelique made an interesting question about the organizati on of the website. However, she was one step ahead of the lesson.</p>
				...
				<p><b>Angelique :</b>  Basically any shape you can imagine, Marciel. I used shape tool to create my site. I had to use it to make the header, search menu, publication area and the
				“who am i” section.</p>
				<p><b>Akira :</b>  Great! Thank you all for your contribution to the lesson.</p>								
				<figure>
					<img src="{{ asset('assets/img/playgo/unit18/ilust_18.jpg') }}" alt="Garotos festejando">
				</figure>
			</div>
		</div>
	</main>
