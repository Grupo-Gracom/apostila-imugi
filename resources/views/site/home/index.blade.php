...
<section class="wow fadeIn bem_vindo_img"  id="matricula" style="background-image: url({{asset('assets/site/images/bg_home.jpg')}}); background-repeat:no-repeat; background-position: center;">
                <div class="container">
            ...
            <img src="{{asset('assets/site/images/quadrado_3.png')}}" alt="" class="quadrado_3">
        <section class="wow fadeIn bg_bvd" style="background-image: url({{asset('assets/site/images/bg-bemvindo.png')}});  background-repeat: no-repeat; background-position: bottom; background-size: 100% 18%;">
            <div class="container ">
                <div class="row align-items-center"> 
                    ...
                    <div class="col-12 col-lg-7 text-center">
                        <a class="popup-youtube" href="https://www.youtube.com/watch?v=ykNaUMOa_Jk">
                            <img src="{{asset('assets/site/images/video-institucional.jpg')}}" alt="" class="w-100">
                            <div class="icon-play">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-12 col-lg-4 col-md-6 text-center md-margin-50px-bottom sm-margin-30px-bottom wow fadeInUp last-paragraph-no-margin">
                        <img src="{{asset('assets/site/images/icone-cg.png')}}" alt="" width="200">
                    ...
                    <!-- start features box item -->
                    <div class="col-12 col-lg-4 col-md-6 text-center md-margin-50px-bottom sm-margin-30px-bottom wow fadeInUp last-paragraph-no-margin">
                            <img src="{{asset('assets/site/images/icone-ingles.png')}}" alt="" width="200">
        ...
        <section class="p-0 wow fadeIn bg-light-gray" id="curso">
                <div class="container-fluid">
                    <div class="row"> 
                            <div class="col-12 col-lg-6 cover-background md-height-400px wow fadeInRight" style="background-image:url({{asset('assets/site/images/bg-cg-fly.jpg')}});"></div>
                        <div class="col-12 col-lg-6 wow fadeInLeft padding-four-all md-padding-eight-all md-padding-15px-lr sm-padding-50px-tb">
                            <div class="row m-0">
                                <div class="col-12 col-xl-10 margin-six-bottom lg-margin-six-bottom md-margin-30px-bottom sm-no-margin-bottom">
                                 <img src="{{asset('assets/site/images/logo-cg-fly.png')}}" alt="" width="360">
                                 <p>
        ...
        <section class="p-0 wow fadeIn bg-light-gray">
            <div class="container-fluid">
                <div class="row"> 
                    <div class="col-12 col-lg-6 wow fadeInLeft padding-four-all md-padding-eight-all md-padding-15px-lr sm-padding-50px-tb">
                        <div class="row m-0">
                            <div style="margin-left: 240px;"  class="col-12 col-xl-10 code_b margin-six-bottom lg-margin-six-bottom md-margin-30px-bottom sm-no-margin-bottom">
                                    <img src="{{asset('assets/site/images/logo-code.png')}}" alt="">
                                    <p class="mt-4">
                    ...
                    <div class="col-12 col-lg-6 cover-background md-height-400px wow fadeInRight" style="background-image:url({{asset('assets/site/images/bg-code-block.jpg')}})"></div>
                </div>
            </div>
        </section>
        <!-- start section -->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg-5 text-center md-margin-50px-bottom wow fadeInLeft">
                            <a class="popup-youtube" href="https://www.youtube.com/watch?v=uf_m3lJ0F-M">
                                <img src="{{asset('assets/site/images/portal_aluno.jpg')}}" alt="">
                                <div class="icon-play">
                                    <div class="absolute-middle-center">
                                        <img src="{{asset('assets/site/images/icon-play.png')}}" alt="">
                                    </div>
        ...
        <section class="wow fadeIn" style="background-image: url({{asset('assets/site/images/depoimentos.png')}}); background-repeat:no-repeat; background-position: bottom; background-position-x: top;">
            <div class="container">
                <div class="row">
