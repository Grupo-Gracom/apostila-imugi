...
<main>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila4" data-unidade="unidade8" data-etapa="listening">
            ...
            <form id="unidade7listening778" method="post" style="margin-top:16px">
...
<script>
    ...
    $("#unidade7listening778").submit(function(e) {
        e.preventDefault();
        $(this).find('button').prop('disabled', true);
        var respostas = '{"' + $('#unidade7listening778 textarea').attr("name") + '":"' + $('#unidade7listening778 textarea').val() + '"}';
        if ($('#unidade7listening778 input[name="resposta_id"').val() != 0) {
            atualizarAtividade($('#unidade7listening778'), respostas);
        } else {
            enviarAtividade($('#unidade7listening778'), respostas);
        }
    });
