...
<!-- WRAPPER ALL -->
	...
	<main>
	    ...
	    <div class="dashboard">
			<div id="unidade" class="box" data-apostila="apostila4" data-unidade="unidade8" data-etapa="understanding">
				<h3 class="barlow">UNIT 8</h3>
				<h5 class="barlow">6 - UNDERSTANDING</h5>
                <div class="metade">
                    <form id="unidade7understanding779" method="post">
                        <p>
    ...
    <script>
        ...
        $("#unidade7understanding779").submit(function(e){
            e.preventDefault();
            $(this).find('button').prop('disabled', true);
            var respostas = '{';
            $('#unidade7understanding779 input[type="text"]').each(function(index){
                if(($('#unidade7understanding779 input[type="text"]').length - 1) == index){
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'"}';
                }else{
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'",';
                }
            });
            if($('#unidade7understanding779 input[name="resposta_id"').val() != 0){
                atualizarAtividade($('#unidade7understanding779'), respostas);
            }else{
                enviarAtividade($('#unidade7understanding779'), respostas);
            }
        });
