...
<main>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila4" data-unidade="unidade8" data-etapa="grammar">
            ...
            <form id="unidade7grammar777" method="post" style="margin-top:32px">
...
<script>
    ...
    $("#unidade7grammar777").submit(function(e) {
        e.preventDefault();
        $(this).find('button').prop('disabled', true);
        var respostas = '{"' + $('#unidade7grammar777 textarea').attr("name") + '":"' + $('#unidade7grammar777 textarea').val() + '"}';
        if ($('#unidade7grammar777 input[name="resposta_id"').val() != 0) {
            atualizarAtividade($('#unidade7grammar777'), respostas);
        } else {
            enviarAtividade($('#unidade7grammar777'), respostas);
        }
    });
