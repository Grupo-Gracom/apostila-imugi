...
@section('titulo','Unit 3 | Tipos de Cortes')
@section('conteudo')
<!-- WRAPPER ALL -->
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila6" data-unidade="unidade3" data-etapa="tipos_de_corte">
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit3/imagem_unit3_1.png') }}" alt="L – Cut">
				</figure>
			</div><br>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit3/imagem_unit3_2.png') }}" alt="L – Cut">
				</figure>
			</div><br>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit3/imagem_unit3_3.png') }}" alt="L – Cut">
				</figure>
			</div><br>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit3/imagem_unit3_4.png') }}" alt="L – Cut">
				</figure>
			</div><br>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit3/imagem_unit3_5.png') }}" alt="L – Cut">
				</figure>
			</div><br>
			<h5>Iris</h5>
			<p>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit3/imagem_unit3_6.png') }}" alt="L – Cut">
				</figure>
			</div><br>

			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit3/imagem_unit3_7.png') }}" alt="L – Cut">
				</figure>
			</div><br>
			<h5>Zoom</h5>
			<p>
