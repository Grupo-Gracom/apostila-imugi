...
@section('titulo','Unit 5 |  Configurações da câmera')
@section('conteudo')
<!-- WRAPPER ALL -->
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila6" data-unidade="unidade11" data-etapa="configuracao_camera">
			...
			<p>
				As configurações da câmera podem ser alteradas a qualquer momento clicando duas vezes na
				layer no painel timeline ou selecionando a layer e escolhendo layer> configurações da câmera.
			...
			<h5>Tipos</h5>
			<p>
				Câmera de um nó ou câmera de dois nós. Uma câmera de um nó se orienta em torno de si
				mesma, enquanto uma câmera de dois nós tem um ponto de interesse e orienta-se em torno
				...
				Para definir a opção de orientação automát ca de uma câmera escolha layer < transform <	Auto-Orient.
			</p>
			<h5>Nome</h5>
			<p>
			...
			<h5>Preset</h5>
			<p>
				Aqui é possível definir o tipo de configurações da câmera que deseja usar. As predefinições
				são nomeadas de acordo com as distâncias focais. Cada predefi nição pretende representar
				o comportamento de uma câmera de 35mm com uma lente de determinada distância focal.
				Portanto, a predefinição também define os valores angle of view, zoom, distância de foco,
				focal length e aperture. A predefinição predefinida é de 50 mm. Também é possível criar uma
				câmera personalizada especificando novos valores para qualquer uma das configurações.
			</p>
			<ul class="unidade_6_5">
				<li>Zoom: a distância da lente para o plano da imagem. Em outras palavras, uma camada
							que é a distância de zoom afastada aparece em seu tamanho completo, uma camada que
							é o dobro da distância do zoom, aparece meio como alta e larga, e assim por diante.
					</li>
					<li>
						Ângulo de visão: a largura da cena capturada na imagem. Os valores do comprimento
						focal, do tamanho do fi lme e do zoom determinam o ângulo de visão. Um ângulo de visão
						mais amplo cria o mesmo resultado que uma lente grande angular.
					</li>
					<li>
						Profundidade do campo: aplica variáveis personalizadas às configurações de distância
						de foco, abertura, f-parada e nível de desfocagem. Usando essas variáveis, é possível manipular a profundidade de campo para criar efeitos de focagem de câmera mais realistas.
					...
					<li>
						Tamanho do fi lme: o tamanho da área exposta do fi lme, que está diretamente relacionado ao tamanho da composição. Ao modifi car o tamanho do fi lme, o valor do zoom muda para coincidir com a perspect va de uma câmera real.
					</li>
					<li>
			...
			<p>
				Uma layer de luz pode afetar as cores das layers 3D que ele brilha, dependendo das confi gurações da luz e das propriedades das opções de material das layers 3D. Cada luz, por padrão,
				...
				uma layer de vídeo como se fosse feita de vitrais. É possível animar todas as confi gurações de	uma luz, exceto o t po de luz e a propriedade casts shadows.
			</p>
				<div class="container">
				<figure>
			...
			<p>
				Ao designar a luz como uma layer de ajuste (coloque a luz no painel timeline acima das layers nas quais você deseja que ele brilhe) você especifi ca quais layers 3D deseja que uma luz afete.
			</p>
			<p>
