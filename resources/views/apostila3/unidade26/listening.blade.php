...
<main>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila3" data-unidade="unidade26" data-etapa="listening">
            ...
            <form id="unidade26listening683" method="post">
                <p>
...
<script>
    ...
    $("#unidade26listening683").submit(function(e) {
        e.preventDefault();
        $(this).find('button').prop('disabled', true);
        var respostas = '{';
        $('#unidade26listening683 input[type="text"]').each(function(index) {
            if (($('#unidade26listening683 input[type="text"]').length - 1) == index) {
                respostas += '"' + $(this).attr("name") + '":"' + $(this).val() + '"}';
            } else {
                respostas += '"' + $(this).attr("name") + '":"' + $(this).val() + '",';
            }
        });
        if ($('#unidade26listening683 input[name="resposta_id"').val() != 0) {
            atualizarAtividade($('#unidade26listening683'), respostas);
        } else {
            enviarAtividade($('#unidade26listening683'), respostas);
        }
    });
