...
<main>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila3" data-unidade="unidade19" data-etapa="listening">
            ...
            <form id="unidade19listening594" method="post">
...
<script>
    ...
    $("#unidade19listening594").submit(function(e) {
        e.preventDefault();
        $(this).find('button').prop('disabled', true);
        var respostas = '{"' + $('#unidade19listening594 textarea').attr("name") + '":"' + $('#unidade19listening594 textarea').val() + '"}';
        if ($('#unidade19listening594 input[name="resposta_id"').val() != 0) {
            atualizarAtividade($('#unidade19listening594'), respostas);
        } else {
            enviarAtividade($('#unidade19listening594'), respostas);
        }
    });
