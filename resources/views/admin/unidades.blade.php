...
<div id="lateral" class="suave">
    ...
    <div id="criar" class="content suave">
        <h4 class="barlow">Criar unidade <i class="material-icons click suave fechar">close</i></h4>
    ...
    function deletar(unidade_id){
        ...
        request.done(function(response){
            if(response == "1"){
                ...
                $("#alerta .opcoes").addClass("hide");
                $("#alerta p").text("Esta unidade possui turmas atreladas a ela, remova suas turmas primeiro!");
                $("#alerta .confirmar").prop('disabled', false);
                setTimeout(function(){
                    $("#alerta").removeClass("active");
                }, 5000);
