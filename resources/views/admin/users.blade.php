...
<div id="lateral" class="suave">
    ...
    <div id="criar" class="content suave">
        <h4 class="barlow">Criar usuario <i class="material-icons click suave fechar">close</i></h4>
    ...
    <div id="editar" class="content suave">
        ...
        <form id="form-editar-usuario" action="{{ route('colaboradores.store') }}" method="post">
            ...
            <input type="email" name="e_usuario_email" id="e_usuario_email" placeholder="Email do usuário" required>
...
<script>
    ...
    $(document).on("click", ".deletar", function(){
        ...
        $("#alerta p").empty();
        $("#alerta p").text("Deseja realmente deletar este usuario ?");
