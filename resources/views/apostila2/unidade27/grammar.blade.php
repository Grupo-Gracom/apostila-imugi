			...
			<div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade27" data-etapa="grammar">
                ...
                <div style="margin-top: 16px">
                    ...
                    <table class="metade center-align">
                        <tr>
                            <td><h5 class="barlow">Necessity - HAVE TO</h5></td>
                        </tr>
                        <tr>
                            <td><p> <b>I have to finish</b> the briefing for the magazine.</p></td>
                        </tr>
                        <tr>
                            <td><p>We <b>have to select</b> the pictures for the article.</p></td>
                        </tr>
                        <tr>
                            <td><h5 class="barlow">Lack of necessity - DON't or DOESN'T HAVE TO</h5></td>
                        </tr>
                        <tr>
                            <td><p>She <b>doesn't have to arrive</b> so early.</p></td>
                        </tr>
                        <tr>
                            <td><p>We <b>don't have to send</b> the report today.</p></td>
                        </tr>
                    </table> 
