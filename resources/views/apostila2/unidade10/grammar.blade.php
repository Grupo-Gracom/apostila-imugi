                ...
                <div style="margin-top: 16px">
                    ...
                    <table class="metade center-align">
                        <tr>
                            ...
                            <td><h5 class="barlow">Future plan / intension</h5></td>
                        </tr>
                        <tr>
                            <td><p> John</p></td>
                            <td><p> is</p></td>
                            <td><p> travel</p></td>
                            <td><p> John <b>is going to travel</b> to NY next week.</p></td>
                        </tr>
                        <tr>
                            <td><p><b>I</b></p></td>
                            <td><p>am</p></td>
                    ...
                    <table class="metade center-align">
                        <tr>
                            ...
                            <td><p>PART</p></td>
                            <td><p>We're gonna see some nice tools today.</p></td>
                        </tr>
                        <tr>
                        <td><h5 class="barlow">ANY (?) (-)</h5></td>
                            <td><p>ALL</p></td>
                            <td>
