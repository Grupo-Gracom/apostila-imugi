			...
			<div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade45" data-etapa="grammar">
                ...
                <div class="metade">
                    <table class="center-align">           
                        <tr>
                            <td><h5 class="barlow"> Drawing a conclusion</h5></td>                                                         														
                        </tr>                                                                             										
                        <tr>
                            <td><p>so, therefore , as I’ve said , based on , as , as a conclusion , to
                    ...
                    <table class="center-align">           
                        <tr class="bordered">
                            ...
                            <td><h5 class="barlow">Connected sentences / conclusion</h5></td>                                                       														
                        </tr>                                                                             										
                        <tr>
