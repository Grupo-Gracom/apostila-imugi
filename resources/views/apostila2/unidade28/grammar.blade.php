			...
			<div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade28" data-etapa="grammar">
                ...
                <div style="margin-top: 16px">
                    ...
                    <table class="metade center-align">
                        <tr>
                            <td><h5 class="barlow">Urgent/strong advice - HAD BETTER + VERB</h5></td>
                        </tr>
                        <tr>
                            <td><p>She <b>had better leave</b> now, otherwise she'll miss the flight.</p></td>
                        </tr>
                        <tr>
                            <td><p>You <b>had better have</b> somebody to help with digital marketing.</p></td>
                        </tr>
                        <tr>
                            <td><h5 class="barlow">HAD BETTER NOT + VERB</h5></td>
                        </tr>
                        <tr>
                            <td><p>They <b>had better not be</b> late for the meeting with the client.</p></td>
                        </tr>
                        <tr>
