                ...
                <div style="margin-top: 16px">
                    ...
                    <table class="metade center-align">
                        ...
                        <tr>
                            ...
                            <td><h5 class="barlow">Long adjective = more + adj + than</h5></td>
                        </tr>
                        <tr>
                            <td><p><b>(fast)</b> Python is faster than Java.</p></td>
                            <td><p><b>(intuitive)</b> Python is more intuitive than Java.</p></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><h5 class="barlow">Long adjective = as + adj + as</h5></td>
                        </tr>
                        <tr>
                            <td><p><b>(cool)</b> Colding is as cool as designing.</p></td>
                            <td><p><b>(beautiful)</b> Picture 1 is as beautiful as number 2.</p></td>
                        </tr>
                        <tr>
                    ...
                    <table class="metade center-align">
                        <tr>
                            ...
                            <td><h5 class="barlow">Comparative</h5></td>
                        </tr>
                        <tr>
                            <td><p>Good / Well</p></td>
                            <td><p>Better</p></td>
                    ...
                    <form id="unidade8grammar419" method="post">
                        <table class="metade center-align">
                            <tr>
                                <td></td>
                                <td><h5 class="barlow">Python</h5></td>
                                <td><h5 class="barlow">Java</h5></td>
                    ...
                    <table class="metade center-align">
                        <tr>
                            <td><h5 class="barlow">COMPANY A</h5></td>
                            <td><h5 class="barlow">COMPANY B</h5></td>
                        </tr>
                        <tr>
                            <td><p>Computers: Very fast</p></td>
                            <td><p>Computers: Medium speed.</p></td>
                        </tr>
                        <tr>
                            <td><p>Budget: Limited.</p></td>
                            <td><p>Budget: Enough</p></td>
                        </tr>
                        <tr>
                            <td><p>Team: Young programmers.</p></td>
                            <td><p>Team: Experienced Old programmers</p></td>
                        </tr>
                        <tr>
                            <td><p>Dead Line: Short</p></td>
                            <td><p>Dead Line: Long</p></td>
                        </tr>
                        <tr>
