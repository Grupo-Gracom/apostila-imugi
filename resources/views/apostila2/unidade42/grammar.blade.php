	...
	<main>
		...
		<div class="dashboard">
			<div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade42" data-etapa="grammar">
                ...
                <div class="clear"></div>                
                <h5 class="barlow" style="margin-top:16px;">RELATIVE PRONOUNS – WHERE , WHEN.</h5>
                <div class="espacamento">                                
                    <table class="bordered">           
                        <tr>
                            <td class="center-align bordered"><h5 class="barlow">RELATIVE PRONOUNS</h5></td>                    														
                            <td class="center-align bordered"><h5 class="barlow">EXAMPPLES</h5></td>                                     														
                        </tr>                                                    										
                        <tr>
                            <td class="center-align bordered">
                                <p class="centralizap">WHERE</p>
                                <p>(Used for places)</p>
                            </td>
                            <td class="left-align bordered">
                                ...
                                <hr>
                                <p>A: The classroom is very dark</p>                                
                ...
                <h5 class="barlow">A - Combine the following sentences using WHERE or WHEN:</h5>                
                ...
                <h5 class="barlow">B - Join the sentences using WHO, WHEN, WHERE, WHICH or WHOSE:</h5>
                ...
                <div class="clear"></div>               
                <h5 class="barlow" style="margin-top: 16px;">C -  Think of a movie you like and write the plot of it. It’s important to write about the
                ...
                <form id="unidade42grammar305" method="post">
                    <textarea name="grammar305-1" class="center-align" placeholder="Responda aqui" required></textarea>
                    <div class="clear"></div>
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                    <input type="hidden" name="resposta_id" value="0">
                    <input type="hidden" name="unidade_id" value="42">
