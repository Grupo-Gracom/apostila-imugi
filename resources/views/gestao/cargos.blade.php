...
<div id="lateral" class="suave">
    ...
    <div id="criar" class="content suave">
        <h4>Criar cargo <i class="material-icons click suave fechar">close</i></h4>
        <form id="form-criar-cargo" action="{{ route('cargos.store') }}" method="post">
            ...
            <div class="list-checkbox">
                ...
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="menu_id_2-4" id="menu_id_2-4" value="2-4"></div>
                    Cronogramas
                </h6>
                <div class="divider"></div>
                <h6>
                    <div class="checkbox click"><input type="checkbox" name="menu_id_4" id="menu_id_4" value="4"></div>
                    Logística
                </h6>
                <h6>
                    <div class="checkbox click"><input type="checkbox" name="menu_id_4-1" id="menu_id_4-1" value="4-1"></div>
                    Produtos
                </h6>
                <div class="divider"></div>
                <h6>
                    <div class="checkbox click"><input type="checkbox" name="menu_id_5" id="menu_id_5" value="5"></div>
                    Portal
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="menu_id_5-1" id="menu_id_5-1" value="5-1"></div>
                    Banners
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="menu_id_5-2" id="menu_id_5-2" value="5-2"></div>
                    Cursos
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="menu_id_5-3" id="menu_id_5-3" value="5-3"></div>
                    Aulas
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="menu_id_5-4" id="menu_id_5-4" value="5-4"></div>
                    Materiais
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="menu_id_5-5" id="menu_id_5-5" value="5-5"></div>
                    Programas
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="menu_id_5-6" id="menu_id_5-6" value="5-6"></div>
                    Categorias
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="menu_id_5-7" id="menu_id_5-7" value="5-7"></div>
                    Suporte
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="menu_id_5-8" id="menu_id_5-8" value="5-8"></div>
                    Provas
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="menu_id_5-9" id="menu_id_5-9" value="5-9"></div>
                    Questões
                </h6>
                <div class="divider"></div>
                <h6>
                ...
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="menu_id_3-10" id="menu_id_3-10" value="3-10"></div>
                    Assinaturas
                </h6>
                <h6>
                ...
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="menu_id_3-7" id="menu_id_3-7" value="3-7"></div>
                    Salas
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="menu_id_3-8" id="menu_id_3-8" value="3-8"></div>
                    Loja
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="menu_id_3-9" id="menu_id_3-9" value="3-9"></div>
                    Meus Pedidos
                </h6>
            </div>
            <div class="esquerda">
    ...
    <div id="editar" class="content suave">
        <h4>Editar cargo <i class="material-icons click suave fechar">close</i></h4>
        <form id="form-editar-cargo" action="{{ route('cargos.store') }}" method="post">
            ...
            <div class="list-checkbox">
                ...
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="e_menu_id_2-4" id="e_menu_id_2-4" value="2-4"></div>
                    Cronogramas
                </h6>
                <div class="divider"></div>
                <h6>
                    <div class="checkbox click"><input type="checkbox" name="e_menu_id_4" id="e_menu_id_4" value="4"></div>
                    Logística
                </h6>
                <h6>
                    <div class="checkbox click"><input type="checkbox" name="e_menu_id_4-1" id="e_menu_id_4-1" value="4-1"></div>
                    Produtos
                </h6>
                <h6>
                    <div class="checkbox click"><input type="checkbox" name="e_menu_id_4-2" id="e_menu_id_4-2" value="4-2"></div>
                    Pedidos
                </h6>
                <div class="divider"></div>
                <h6>
                    <div class="checkbox click"><input type="checkbox" name="e_menu_id_5" id="e_menu_id_5" value="5"></div>
                    Portal
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="e_menu_id_5-1" id="e_menu_id_5-1" value="5-1"></div>
                    Banners
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="e_menu_id_5-2" id="e_menu_id_5-2" value="5-2"></div>
                    Cursos
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="e_menu_id_5-3" id="e_menu_id_5-3" value="5-3"></div>
                    Aulas
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="e_menu_id_5-4" id="e_menu_id_5-4" value="5-4"></div>
                    Materiais
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="e_menu_id_5-5" id="e_menu_id_5-5" value="5-5"></div>
                    Programas
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="e_menu_id_5-6" id="e_menu_id_5-6" value="5-6"></div>
                    Categorias
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="e_menu_id_5-7" id="e_menu_id_5-7" value="5-7"></div>
                    Suporte
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="e_menu_id_5-8" id="e_menu_id_5-8" value="5-8"></div>
                    Provas
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="e_menu_id_5-9" id="e_menu_id_5-9" value="5-9"></div>
                    Questões
                </h6>
                <div class="divider"></div>
                <h6>
                ...
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="e_menu_id_3-10" id="e_menu_id_3-10" value="3-10"></div>
                    Assinaturas
                </h6>
                <h6>
                ...
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="e_menu_id_3-7" id="e_menu_id_3-7" value="3-7"></div>
                    Salas
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="e_menu_id_3-8" id="e_menu_id_3-8" value="3-8"></div>
                    Loja
                </h6>
                <h6>
                    <div class="checkbox click suave"><input type="checkbox" name="menu_id_3-9" id="menu_id_3-9" value="3-9"></div>
