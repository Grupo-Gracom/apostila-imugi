...
<!-- WRAPPER ALL -->
	...
	<main>
		...
		<div class="dashboard">
			<div id="unidade" class="box" data-unidade="unidade16" data-etapa="grammar">
                ...
                <p>STRUCTURE:</p>
                <p>AFFIRMATIVE: SUBJECT + WOULD + VERB</p>
                <p>EXAMPLE: I WOULD LIKE TO VISIT PARIS ONE DAY.</p>
                <p>INTERROGATIVE: WOULD + SUBJECT + VERB</p>
                <p>EXAMPLE: WOULD YOU LIKE TO GO WITH ME TO THE GAME?</p>
                <p>NEGATIVE: SUBJECT + WOULD + NOT + VERB</p>
                <p>EXAMPLE: I WOULDN’T LIKE TO LIVE THERE.</p>             
                <div class="clear"></div>
				<h5 class="barlow">A - CREATE QUESITONS FOR THE ANSWERS USING WOULD:</h5>
				<form class="metade" id="unidade16grammar45" method="post">
                    <p><b>1.Question: </b><input type="text" name="grammar45-1" class="full" required></p>
                    <p style="margin-bottom:50px;"><b>Answer: </b>Yes, I Would Love To Go With You To The Movies.</p>
                    <p><b>2.Question: </b><input type="text" name="grammar45-2" class="full" required></p>
                    <p style="margin-bottom:50px;"><b>Answer: </b>No, I’m Sorry. I Don’t Drink.</p>
                    <p><b>3.Question: </b><input type="text" name="grammar45-3" class="full" required></p>
                    <p style="margin-bottom:50px;"><b>Answer: </b>No, I Don’t Think They Would Need Help With The Exercise.</p>                    
				...
				<form class="metade" id="unidade16grammar46" method="post">
                    ...
                    <p style="margin-bottom:50px;"><b>Answer: </b><input type="text" name="grammar46-1" class="full" required></p>
                    <p><b>1.Question: </b>What Would You Buy With A Million Dollars?</p>
                    <p style="margin-bottom:50px;"><b>Answer: </b><input type="text" name="grammar46-2" class="full" required></p>
                    <p><b>1.Question: </b>Where Would You Like To Visit?</p>
                    <p style="margin-bottom:50px;"><b>Answer: </b><input type="text" name="grammar46-3" class="full" required></p>                    
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                    <input type="hidden" name="resposta_id" value="0">
                    <input type="hidden" name="unidade_id" value="16">
