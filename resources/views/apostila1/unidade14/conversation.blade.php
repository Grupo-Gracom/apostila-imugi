...
<!-- WRAPPER ALL -->
	...
	<main>
		...
		<div class="dashboard">
			<div id="unidade" class="box" data-unidade="unidade14" data-etapa="conversation">
				...
				<p style="margin-top: 16px"><b>Beatriz :</b> What’s up everyone! We studied a little about color tools and typography tools. Today, we are going to review some of the content we talked about.</p>
				...
				<div class="metade" style="margin-top: 36px">
					<figure>
						<img src="{{ asset('assets/img/playgo/unit14/pagina-1.png') }}" alt="Garotos festejando">
					</figure>
				</div>
			</div>
		</div>
